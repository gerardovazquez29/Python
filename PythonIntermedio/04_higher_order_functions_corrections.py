...
def sum_closure():
    def add(value):
        return value + 10
    return add
add_closure = sum_closure()
print(add_closure(5))  # 15

# 2. Crea una función que reciba dos números y una función, y 
# devuelva el resultado de sumar los dos números y aplicar la función.
...
# 10. Crea una función que reciba una lista y una función, y aplique esa función a 
# cada elemento usando un bucle (sin map).
